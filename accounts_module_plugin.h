...
#include "accounts_module_interface.h"
#include "logos_api.h"
...
class AccountsModulePlugin : public QObject, public AccountsModuleInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AccountsModuleInterface_iid FILE "metadata.json")
    Q_INTERFACES(AccountsModuleInterface PluginInterface)

public:
    AccountsModulePlugin();
    ~AccountsModulePlugin();
    ...
    Q_INVOKABLE QString extKeystoreDerive(const QString &address, const QString &derivationPath, int pin) override;
    Q_INVOKABLE QString extKeystoreDeriveWithPassphrase(const QString &address, const QString &derivationPath, int pin, const QString &passphrase, const QString &newPassphrase) override;
